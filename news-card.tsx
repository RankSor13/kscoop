...
// ✅ Safety net — if a scraped/source image 404s or gets hotlink-blocked,
// swap in a known-good placeholder instead of showing a broken <img> icon.
// The `data-fallback` guard stops an infinite loop if the fallback itself
// ever fails to load.
